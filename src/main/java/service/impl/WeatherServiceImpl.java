...
import static service.ApiConstants.GET_WEATHER_URL;
import static service.ApiConstants.MY_KEY;
...
public class WeatherServiceImpl implements WeatherService {
  ...
  @SneakyThrows
    public String getByCityName(String city) {
       ...
       var request = HttpRequest.newBuilder().GET().uri(URI.create(GET_WEATHER_URL + city + MY_KEY)).build();
